...
class Edrone():
    ...
    def __init__(self):
        ...
        self.setpoint = [0.0,0.0,30.0,0.0] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
        ...
        self.max_values = [1800,1600,1800,1600]
